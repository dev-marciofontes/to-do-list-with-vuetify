  ...
  <v-app id="inspire">
    <v-navigation-drawer v-model="drawer">
      <v-img src="https://picsum.photos/1920/1080?random"
        ...
        <v-list>
          <v-list-item prepend-avatar="https://avatars.githubusercontent.com/u/122459204?v=4" title="Márcio Fontes"
            v-bind:style="{ color: 'white' }">
            <p style="color: white; font-size: 13px;">To Do List</p>
          </v-list-item>
        </v-list>
      </v-img>
    ...
    <v-app-bar color="teal-darken-4" image="https://picsum.photos/1920/1080?random" density="prominent">
